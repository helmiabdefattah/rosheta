...
Route::middleware([
    ...
    Route::get('/demo-invite', [App\Http\Controllers\Admin\DemoInviteController::class, 'edit'])->name('demo-invite.edit');
    Route::put('/demo-invite', [App\Http\Controllers\Admin\DemoInviteController::class, 'update'])->name('demo-invite.update');
