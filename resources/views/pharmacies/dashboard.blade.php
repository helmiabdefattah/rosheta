            ...
            @if($recentRequests->count() > 0)
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">{{ app()->getLocale() === 'ar' ? 'عدد الأدوية' : 'Medicines Count' }}</th>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 py-1 text-xs font-semibold rounded-full bg-blue-100 text-blue-800">
                                    {{ $request->lines->where('item_type', 'medicine')->count() ?? 0 }} {{ app()->getLocale() === 'ar' ? 'دواء' : 'Medicine(s)' }}
                                </span>
                            </td>
                            <td class="px-6 py-4">
                                @if($request->address)
