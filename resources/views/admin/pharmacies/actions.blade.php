<div class="flex items-center gap-2">
    ...
    <form action="{{ route('admin.pharmacies.destroy', $pharmacy) }}" method="POST" class="inline" onsubmit="return confirm('{{ app()->getLocale() === 'ar' ? 'هل أنت متأكد من الحذف؟' : 'Are you sure?' }}');">
        @csrf
        @method('DELETE')
