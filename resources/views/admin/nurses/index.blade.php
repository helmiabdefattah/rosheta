...
@section('content')
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 table-scroll-container">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            @foreach($nurses as $nurse)
                <tr>
                    ...
                    <td class="px-4 py-2 text-sm text-gray-700">{{ $nurse->user->name ?? '-' }}</td>
                    <td class="px-4 py-2 text-sm text-gray-700">{{ $nurse->user->phone_number ?? '-' }}</td>
                    <!-- <td class="px-4 py-2 text-sm text-gray-700">{{ $nurse->user->email ?? '-' }}</td> -->
                    <td class="px-4 py-2 text-sm text-gray-700">
                        @php
