	...
	<div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
			...
			<div class="md:col-span-2">
				...
				<textarea name="certifications" rows="2" class="w-full border border-gray-300 rounded-lg p-2">{{ old('certifications', implode(', ', (array) $nurse->certifications)) }}</textarea>
			</div>
			<div class="md:col-span-2">
				...
				<textarea name="skills" rows="2" class="w-full border border-gray-300 rounded-lg p-2">{{ old('skills', implode(', ', (array) $nurse->skills)) }}</textarea>
			</div>
		</div>
	</div>
