    ...
    <div class="flex h-screen min-w-full overflow-hidden">
        ...
        <aside id="sidebar" class="fixed lg:static inset-y-0 z-50 w-64 bg-sidebar text-white flex flex-col shadow-2xl sidebar-transition {{ app()->getLocale() === 'ar' ? 'sidebar-closed-rtl' : 'sidebar-closed-ltr' }} lg:translate-x-0 lg:h-screen h-full">
            ...
            <nav class="flex-1 overflow-y-auto p-4 sidebar-scroll">
                ...
                <a href="{{ route('admin.demo-surveys.index') }}" class="nav-item {{ request()->routeIs('admin.demo-surveys.*', 'admin.demo-runs.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 me-3 opacity-70" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/>
                    </svg>
                    <span>{{ app()->getLocale() === 'ar' ? 'تحليل التجارب' : 'Demo Analytics' }}</span>
                </a>

                <a href="{{ route('admin.demo-invite.edit') }}" class="nav-item {{ request()->routeIs('admin.demo-invite.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 me-3 opacity-70" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/>
                    </svg>
                    <span>{{ app()->getLocale() === 'ar' ? 'دعوة التجربة المجانية' : 'Free Trial Invitation' }}</span>
                </a>
                ...
                <a href="{{ route('admin.governorates.index') }}" class="nav-item {{ request()->routeIs('admin.governorates.*') ? 'active' : '' }}">
                    ...
                    <span>{{ app()->getLocale() === 'ar' ? 'المحافظات' : 'Governorates' }}</span>
                </a>
                ...
                <a href="{{ route('admin.cities.index') }}" class="nav-item {{ request()->routeIs('admin.cities.*') ? 'active' : '' }}">
                    ...
                    <span>{{ app()->getLocale() === 'ar' ? 'المدن' : 'Cities' }}</span>
                </a>
                ...
                <a href="{{ route('admin.areas.index') }}" class="nav-item {{ request()->routeIs('admin.areas.*') ? 'active' : '' }}">
                    ...
                    <span>{{ app()->getLocale() === 'ar' ? 'المناطق' : 'Areas' }}</span>
                </a>

                <a href="{{ route('admin.charitable-organizations.index') }}" class="nav-item {{ request()->routeIs('admin.charitable-organizations.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 me-3 opacity-70" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/>
                    </svg>
                    <span>{{ app()->getLocale() === 'ar' ? 'المنظمات الخيرية' : 'Charitable Organizations' }}</span>
                </a>
                ...
                <a href="{{ route('admin.clinic-onboarding.create') }}" class="nav-item {{ request()->routeIs('admin.clinic-onboarding.*') ? 'active' : '' }}">
                    ...
                    <span>{{ app()->getLocale() === 'ar' ? 'إنشاء عيادة متكاملة' : 'Clinic Quick Setup' }}</span>
                </a>

                <a href="{{ route('admin.specializations.index') }}" class="nav-item {{ request()->routeIs('admin.specializations.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 me-3 opacity-70" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z"/>
                    </svg>
                ...
                <a href="{{ route('admin.doctors.index') }}" class="nav-item {{ request()->routeIs('admin.doctors.*') ? 'active' : '' }}">
                    ...
                    <span>{{ app()->getLocale() === 'ar' ? 'الأطباء' : 'Doctors' }}</span>
                </a>
                ...
                <a href="{{ route('admin.clinics.index') }}" class="nav-item {{ request()->routeIs('admin.clinics.*') ? 'active' : '' }}">
                    ...
                    <span>{{ app()->getLocale() === 'ar' ? 'العيادات' : 'Clinics' }}</span>
                </a>

                <a href="{{ route('admin.medical-centers.index') }}" class="nav-item {{ request()->routeIs('admin.medical-centers.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 me-3 opacity-70" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 21h18M9 8h1m-1 4h1m4-4h1m-1 4h1M5 21V5a2 2 0 012-2h10a2 2 0 012 2v16M9 21v-4a1 1 0 011-1h4a1 1 0 011 1v4"/>
                    </svg>
                    <span>{{ app()->getLocale() === 'ar' ? 'المراكز الطبية' : 'Medical Centers' }}</span>
                </a>

                <a href="{{ route('admin.providers-network.index') }}" class="nav-item {{ request()->routeIs('admin.providers-network.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 me-3 opacity-70" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
                    </svg>
                    <span>{{ app()->getLocale() === 'ar' ? 'استيراد مقدمي الخدمة' : 'Import providers' }}</span>
                </a>
                ...
                <a href="{{ route('admin.appointments.index') }}" class="nav-item {{ request()->routeIs('admin.appointments.*') ? 'active' : '' }}">
                    ...
                    <span>{{ app()->getLocale() === 'ar' ? 'حجز المواعيد' : 'Appointments' }}</span>
                </a>
            </nav>
