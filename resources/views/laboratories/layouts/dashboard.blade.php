...
@php
    ...
    $labIsRadiology = $currentLaboratory && $currentLaboratory->type === 'radiology';
@endphp
...
{{--                </a>--}}
                ...
                <a href="{{ route('laboratories.test-prices.index') }}" class="nav-item {{ request()->routeIs('laboratories.test-prices.*') ? 'active' : '' }}">
                    ...
                    <span>{{ app()->getLocale() === 'ar' ? ($labIsRadiology ? 'أسعار الأشعة' : 'أسعار التحاليل') : ($labIsRadiology ? 'Radiology Prices' : 'Test Prices') }}</span>
                </a>
