...
<div class="max-w-4xl mx-auto">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('laboratories.support-tickets.create') }}" class="px-4 py-2 bg-primary text-white rounded-lg hover:bg-teal-700 transition duration-200 text-sm font-medium">
    ...
    @else
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
            ...
            <a href="{{ route('laboratories.support-tickets.create') }}" class="inline-flex items-center px-6 py-3 bg-primary text-white rounded-lg hover:bg-teal-700 transition duration-200 font-medium">
