...
<body>
    <div class="container">
        <h1 class="mb-4">Create Laboratory</h1>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" name="lat" id="lat" class="form-control" step="0.00000001" value="{{ old('lat') }}">
                        </div>
                        <div class="col-md-3 mb-3">
                            <label class="form-label">Longitude</label>
                            <input type="number" name="lng" id="lng" class="form-control" step="0.00000001" value="{{ old('lng') }}">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="manager_license" class="form-control" value="{{ old('manager_license') }}">
                        </div>
                    </div>
                </div>
            </div>
