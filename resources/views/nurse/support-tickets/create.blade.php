...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 lg:p-8">
        ...
        <form method="POST" action="{{ route('nurse.support-tickets.store') }}" class="space-y-6">
            @csrf
            ...
            <div class="flex items-center justify-end gap-4 pt-4 border-t border-gray-200">
                <a href="{{ route('nurse.dashboard') }}" class="px-6 py-3 text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition duration-200">
    ...
    <div class="mt-6 text-center">
        <a href="{{ route('nurse.support-tickets.index') }}" class="text-primary hover:underline text-sm">
